...
app = Flask(__name__)
cred = credentials.Certificate("miaapp-d291d-firebase-adminsdk-fbsvc-6eccccbd62.json")
...
# Store last recognized face and timestamp
detection_cache = {"last_person": "Unknown", "timestamp": 0}
...
def recognize_face():
    ...
    if recognized_person == detection_cache["last_person"] and (current_time - detection_cache["timestamp"]) < 2:
        recognized_person = detection_cache["last_person"]
    else:
        detection_cache["last_person"] = recognized_person
        detection_cache["timestamp"] = current_time
